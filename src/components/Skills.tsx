  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'Next.js', level: 88, color: 'from-gray-400 to-red-600' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Django', level: 87, color: 'from-gray-500 to-blue-700' },
        { name: 'Ionic', level: 95, color: 'from-gray-500 to-purple-700' },
        { name: 'Express.js', level: 87, color: 'from-gray-500 to-blue-700' },
        { name: 'Docker', level: 65, color: 'from-green-500 to-green-700' },
        { name: 'Flask', level: 87, color: 'from-gray-500 to-purple-700' },
